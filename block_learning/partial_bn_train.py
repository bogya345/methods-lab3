...
from bayesian.train_bn import parameter_learning, parameter_learning_simple, parameter_learning_mix
import numpy as np
...
def hierarchical_train (hybns: list, data: pd.DataFrame) -> HyBayesianNetwork:
    ...
    # param_dict = parameter_learning_simple(data, nodes_type, skeleton)
    # param_dict = parameter_learning_mix(data, nodes_type, skeleton)

    # param_dict = parameter_learning(data, nodes_type, skeleton, 'simple')
    # param_dict = parameter_learning(data, nodes_type, skeleton, 'mix')
